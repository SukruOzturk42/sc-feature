package ftool.repository;

import ftool.ScFeatureApp;
import ftool.config.Constants;
import ftool.config.audit.AuditEventConverter;
import ftool.domain.PersistentAuditEvent;
...
import static ftool.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
